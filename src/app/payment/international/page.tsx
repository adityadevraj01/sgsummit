...
import { CheckCircle, MessageCircle, ShieldCheck, Globe } from "lucide-react"
      ...
      <main className="pt-20 pb-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 animate-fade-in-up">
            <h1 className="text-4xl md:text-5xl font-bold mb-3 gradient-text">Complete Your Payment (International)</h1>
          ...
          <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <Button asChild className="bg-gradient-to-r from-purple-600 to-pink-600">
                    <a
                      href={`https://wa.me/919439019933?text=${encodeURIComponent(
                        "Hi! I want to pay for Community Access ($19.99) – please send the payment link."
                      )}`}
                      target="_blank"
            ...
            <Card className="border-0 shadow-xl bg-white/95">
              <CardHeader>
                ...
                <CardDescription>Full delegate package included.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-slate-700">Price</span>
                ...
                <div className="flex flex-wrap gap-3">
                  <Button asChild className="bg-gradient-to-r from-blue-600 to-cyan-600">
                    <a
                      href={`https://wa.me/919439019933?text=${encodeURIComponent(
                        "Hi! I want to pay $497 for International Summit Participation – please send the payment link."
                      )}`}
                      target="_blank"
                      rel="noopener noreferrer"
                    >
